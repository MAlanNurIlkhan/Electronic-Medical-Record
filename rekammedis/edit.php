		...
		<div class="col-lg-6 col-lg-offset-3">
			...
			<form action="proses.php" method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="berat_badan" id="berat_badan" class="form-control" value="<?= $data['berat_badan'] ?>" required="">
				</div>
				<div class="form-group">
					<label for="tinggi_badan">Tinggi Badan</label>
					<input type="text" name="tinggi_badan" id="tinggi_badan" class="form-control" value="<?= $data['tinggi_badan'] ?>" required="">
				</div>
				<div class="form-group">
					<label for="jenis_perawatan">Jenis Perawatan</label>
					<select name="jenis_perawatan" id="jenis_perawatan" class="form-control" required="">
						<option value="rawat_inap" <?= $data['jenis_perawatan'] == 'rawat_inap' ? 'selected' : '' ?>>Rawat Inap</option>
						<option value="rawat_jalan" <?= $data['jenis_perawatan'] == 'rawat_jalan' ? 'selected' : '' ?>>Rawat Jalan</option>
					</select>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="biaya" id="biaya" class="form-control" value="<?= $data['biaya'] ?>" required="">
				</div>
				<div class="form-group">
