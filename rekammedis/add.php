        ...
        <div class="col-lg-6 col-lg-offset-3">
            <form action="proses.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tinggi_badan" id="tinggi_badan" class="form-control" required>
                </div>

                <div class="form-group">
                    <label for="rawat">Jenis Perawatan</label>
                    <select name="rawat" id="rawat" class="form-control" required>
                        <option value="">- Pilih -</option>
